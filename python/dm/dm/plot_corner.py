...
labels = [r'$\rho_b\times 10^2$', r'$\sigma_z$', r'$\rho_{\textup{DM}}\times 10^2$', r'$\log \nu_0$', r'$R$', r'$z_{\odot}$', r'$w_0$', r'$\log \sigma_{w1}$', r'$\log a_1$']
if model_kind == 2:
    labels += [r'$\log \sigma_{w2}$', r'$\log a_2$']
print("plot corners...")
t0 = time()
utils.plot_corner(params, labels, path=join(current_dir, 'plots', f'corner-({data_kind})-{add_name}{model_kind}-dm.png'))
