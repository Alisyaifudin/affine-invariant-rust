...
pub const LOG_NU0_INDEX: usize = 24;
pub const R_INDEX: usize = 24 + 1;
pub const ZSUN_INDEX: usize = 24 + 2;
pub const W0_INDEX: usize = 24 + 3;
pub const LOG_SIGMAW1_INDEX: usize = 24 + 4;
pub const LOG_A1_INDEX: usize = 24 + 5;
pub const LOG_SIGMAW2_INDEX: usize = 24 + 6;
pub const LOG_A2_INDEX: usize = 24 + 7;
...
pub fn generate_p0_1(nwalkers: usize, locs: Array1<f64>, scales: Array1<f64>) -> Array2<f64> {
    ...
    let p0 = rhob
        ...
        .collect::<Vec<f64>>();
    let res = Array2::from_shape_vec((30, nwalkers), p0)
        .unwrap()
        .t()
        .to_owned();
    res
...
pub fn generate_p0_2(nwalkers: usize, locs: Array1<f64>, scales: Array1<f64>) -> Array2<f64> {
    ...
    let p0 = rhob
        ...
        .collect::<Vec<f64>>();
    let res = Array2::from_shape_vec((32, nwalkers), p0)
        .unwrap()
        .t()
        .to_owned();
    res
